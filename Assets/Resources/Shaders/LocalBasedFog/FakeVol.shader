    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float getDensity(float3 worldPos)
            {
                ...
                density = saturate(density - _DensityThreshold) * _DensityMultiplier / 200;
                return density;
            }
            ...
            half4 Frag(Varyings IN) : SV_Target {
                ...
                while (distTravelled < distLimit)
                {
                    ...
                    if (Density > 0)
                    {
                        ...
                        fogCol.rgb += mainLight.color.rgb * _LightContribution.rgb * henyey_geenstein(dot(rayDir, mainLight.direction), _LightScattering) * Density * mainLight.shadowAttenuation * _StepSize;
